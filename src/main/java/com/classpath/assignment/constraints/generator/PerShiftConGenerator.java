...
public class PerShiftConGenerator extends AbstractConstraintsGenerator implements ConstraintsGeneratorIF {
	 ...
	 */
	public PerShiftConGenerator(List<WorkstationTimeSlot> workstations, Set<String> workerIds, int maxCount) {
	...
	private void recordPositions(List<WorkstationTimeSlot> workstations) {
	...
	private void init(List<WorkstationTimeSlot> workstations, Set<String> workerIds) {
